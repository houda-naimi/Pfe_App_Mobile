...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "PfeShell.Android.dll" comes first in this list. */
		"PfeShell.Android.dll",
		"FormsViewGroup.dll",
		"Lottie.Android.dll",
		"Lottie.Forms.dll",
		"MvvmHelpers.dll",
		...
		"Sharpnado.CollectionView.dll",
		"Sharpnado.CollectionView.Droid.dll",
		"Sharpnado.HorizontalListView.dll",
		"Sharpnado.HorizontalListView.Droid.dll",
